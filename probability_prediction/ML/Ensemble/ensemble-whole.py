...
clf3 = make_pipeline(StandardScaler(), SVC(gamma='scale', probability=True, random_state=1))  # SVC requires scaled inputs

# Create the ensemble model
eclf = VotingClassifier(estimators=[('rf', clf1), ('gb', clf2), ('svc', clf3)], voting='soft')
