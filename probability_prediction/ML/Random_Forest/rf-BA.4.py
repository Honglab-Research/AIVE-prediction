...
use_clade = ['19A', '19B', '20G', '21K', '20E', '20A', '20C', '20B', '21J', '20D', '20I', '20J', '20H', '21C', '20F', '21L', '21F', '21I', 'recombinant', '21H', '21A', '22C', '22A', '21D', '21G', '21E', '21B', '21M', '22D']
...
for i, target_label in enumerate(target_labels):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'/data/cov_metadata/rf-ba4/rf-{target_label}.png', dpi=300)
